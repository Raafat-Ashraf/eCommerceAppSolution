...
namespace eCommerceApp.Infrastructure.Data.Migrations
{
    ...
    [Migration("20241122153001_FixProductAndCategoryIds")]
    partial class FixProductAndCategoryIds
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("eCommerceApp.Domain.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        ...
                        .HasDefaultValue(new Guid("4902c18a-0441-47e5-baa1-27b1cbed279c"));
            ...
            modelBuilder.Entity("eCommerceApp.Domain.Entities.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("59773ec6-b7ee-4811-bb2f-333f8582186b"));
